...
import 'package:ivorypay/utils/constants.dart';
import 'package:ivorypay/utils/enums.dart';
import 'package:ivorypay/utils/error_handler.dart';
import 'package:ivorypay/utils/http.dart';
  ...
  Future<HTTPResponseModel> runApi({
    ...
    try {
      ...
      if (error.response?.statusCode == StatusUnauthorized &&
        ...
        _navigation.pushNamedAndRemoveUntil(entryLoginScreenRoute);
      } else if (showError) {
        if (error.error.toString().contains("SocketException")) {
